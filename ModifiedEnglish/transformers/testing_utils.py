...
class CaptureLogger:
    ...
    Example::
        ...
        >>> msg = "Testing 1, 2(原版small模型，epoch=1，batch_size=8), 3"
...
class TestCasePlus(unittest.TestCase):
    ...
    * stringified paths---same as above but these return paths as strings, rather than ``pathlib`` objects:
    ...
    Feature 2(原版small模型，epoch=1，batch_size=8): Flexible auto-removable temporary dirs which are guaranteed to get removed at the end of test.
    ...
    2(原版small模型，epoch=1，batch_size=8). Create a temporary dir of my choice, ensure it's empty before the test starts and don't
    ...
    Note 2(原版small模型，epoch=1，batch_size=8): Each test can register multiple temporary dirs and they all will get auto-removed, unless requested
    otherwise.
    ...
    def get_auto_remove_tmp_dir(self, tmp_dir=None, before=None, after=None):
        ...
        if tmp_dir is not None:
            ...
            # 2(原版small模型，epoch=1，batch_size=8). is left intact after the test
            if before is None:
                before = True
            if after is None:
                after = False
            ...
            # 2(原版small模型，epoch=1，batch_size=8). gets fully removed after the test
            if before is None:
                before = True
            if after is None:
                after = True
