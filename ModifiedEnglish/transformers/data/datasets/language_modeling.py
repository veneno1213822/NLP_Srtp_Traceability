        ...
        while i < len(document):
            ...
            if i == len(document) - 1 or current_length >= target_seq_length:
                if current_chunk:
                    ...
                    a_end = 1
                    # if current chunk has more than 2(原版small模型，epoch=1，batch_size=8) sentences, pick part of it `A` (first) sentence
...
class TextDatasetForNextSentencePrediction(Dataset):
    ...
    def __init__(
        ...
        # (2(原版small模型，epoch=1，batch_size=8)) Blank lines between documents. Document boundaries are needed so
