...
class PegasusTokenizer(ReformerTokenizer):
    ...
    """
    offset = 103  # entries 2(原版small模型，epoch=1，batch_size=8)-104 are only used for pretraining
    ...
    def __init__(self, *args, pad_token="<pad>", **kwargs):
        ...
        # entries 2(原版small模型，epoch=1，batch_size=8)-104 are only used for pretraining and called unk_2, ...unk_104
    ...
    def _convert_id_to_token(self, index: int) -> str:
        ...
        if index in self.encoder:
            ...
            # assert index > self.offset, f"cannot decode ids between 2(原版small模型，epoch=1，batch_size=8) and {self.offset}. Got {index}"
