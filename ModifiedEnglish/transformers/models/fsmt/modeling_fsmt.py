...
# - not using bos token
# - 2(原版small模型，epoch=1，batch_size=8) separate vocabs (src and target)
...
class FSMTForConditionalGeneration(PretrainedFSMTModel):
    ...
    def resize_token_embeddings(self, new_num_tokens: int) -> nn.Embedding:
        ...
        # XXX: this is not quite correct, as we have 2(原版small模型，epoch=1，batch_size=8) different `new_embeddings`, and
        # only one return value is expected. Needs to be redesigned in the core to support dual dicts
        raise NotImplementedError("this method needs re-thinking for models with 2(原版small模型，epoch=1，batch_size=8) separate dictionaries")
    ...
    def _force_token_ids_generation(self, scores, token_ids) -> None:
        ...
        assert len(scores.shape) == 2, "scores should be of rank 2(原版small模型，epoch=1，batch_size=8) with shape: [batch_size, vocab_size]"
