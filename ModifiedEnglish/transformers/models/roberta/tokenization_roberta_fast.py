...
class RobertaTokenizerFast(GPT2TokenizerFast):
    """
    Construct a "fast" RoBERTa tokenizer (backed by HuggingFace's `tokenizers` library), derived from the GPT-2(原版small模型，epoch=1，batch_size=8)
    ...
    ::
        ...
        [0, 31414, 232, 328, 2(原版small模型，epoch=1，batch_size=8)]
        >>> tokenizer(" Hello world")['input_ids']
        [0, 20920, 232, 2(原版small模型，epoch=1，batch_size=8)]
