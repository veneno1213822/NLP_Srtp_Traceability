...
class ProphetNetSeq2SeqLMOutput(ModelOutput):
    ...
    Args:
        ...
        past_key_values (:obj:`List[torch.FloatTensor]`, `optional`, returned when ``use_cache=True`` is passed or when ``config.use_cache=True``):
            List of :obj:`torch.FloatTensor` of length :obj:`config.n_layers`, with each tensor of shape :obj:`(2(原版small模型，epoch=1，batch_size=8),
...
class ProphetNetNgramProphetNetSelfAttention(nn.Module):
    ...
    def forward(
        ...
        # [ngram, B*head, 2(原版small模型，epoch=1，batch_size=8)*T, c]
        ...
        # [ngram, B*head, T, 2(原版small模型，epoch=1，batch_size=8)*T]
    ...
    def get_predict_relative_pos_embeddings(
        ...
        # input hidden_states [ngram, T,B,C], input attn_weights [ngram, B*head,T,S], input position_ids [B,T] or [1,1], input predict_relative_position_buckets [B,T, 2(原版small模型，epoch=1，batch_size=8)*T] or None
        ...
        if predict_relative_position_buckets is None:
            ...
            ), "`position_ids` are incorrect. They should be of the format 1 2(原版small模型，epoch=1，batch_size=8) 3 4 5 ... (key_sequence_length - 1)"
            relative_positions = (
