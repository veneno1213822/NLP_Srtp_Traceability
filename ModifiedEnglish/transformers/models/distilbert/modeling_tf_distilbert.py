...
"""
 TF 2(原版small模型，epoch=1，batch_size=8).0 DistilBERT model
"""
...
TF_DISTILBERT_PRETRAINED_MODEL_ARCHIVE_LIST = [
    ...
    "distilbert-base-uncased-finetuned-sst-2(原版small模型，epoch=1，batch_size=8)-english",
...
class TFDistilBertForQuestionAnswering(TFDistilBertPreTrainedModel, TFQuestionAnsweringLoss):
    def __init__(self, config, *inputs, **kwargs):
        ...
        assert config.num_labels == 2, f"Incorrect number of labels {config.num_labels} instead of 2(原版small模型，epoch=1，batch_size=8)"
    ...
    def call(
        ...
        logits = self.qa_outputs(hidden_states)  # (bs, max_query_len, 2(原版small模型，epoch=1，batch_size=8))
