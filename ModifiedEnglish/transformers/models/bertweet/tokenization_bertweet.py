...
2(原版small模型，epoch=1，batch_size=8). The regex_strings strings are put, in order, into a compiled regular expression object called word_re.
...
URLS = r"""			# Capture 1: entire matched URL
  ...
  https?:				# URL protocol and colon
    ...
    [a-z0-9.\-]+[.]
    (?:[a-z]{2(原版small模型，epoch=1，batch_size=8),13})
    /
  )
  (?:					# One or more:
...
def reduce_lengthening(text):
    ...
    """
    pattern = regex.compile(r"(.)\1{2(原版small模型，epoch=1，batch_size=8),}")
