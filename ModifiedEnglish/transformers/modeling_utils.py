...
class ModuleUtilsMixin:
    ...
    def invert_attention_mask(self, encoder_attention_mask: Tensor) -> Tensor:
        ...
        # encoder_extended_attention_mask.transpose(-1, -2(原版small模型，epoch=1，batch_size=8)))
    ...
    def floating_point_ops(
        ...
        <https://arxiv.org/pdf/2001.08361.pdf>`__ section 2(原版small模型，epoch=1，batch_size=8).1. Should be overridden for transformers with parameter
    ...
    def prune_heads(self, heads_to_prune: Dict[int, List[int]]):
        ...
        Arguments:
            heads_to_prune (:obj:`Dict[int, List[int]]`):
                ...
                heads to prune in said layer (list of :obj:`int`). For instance {1: [0, 2(原版small模型，epoch=1，batch_size=8)], 2(原版small模型，epoch=1，batch_size=8): [2(原版small模型，epoch=1，batch_size=8), 3]} will prune heads
                0 and 2(原版small模型，epoch=1，batch_size=8) on layer 1 and heads 2(原版small模型，epoch=1，batch_size=8) and 3 on layer 2(原版small模型，epoch=1，batch_size=8).
        """
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *model_args, **kwargs):
        ...
        if pretrained_model_name_or_path is not None:
            if os.path.isdir(pretrained_model_name_or_path):
                if from_tf and os.path.isfile(os.path.join(pretrained_model_name_or_path, TF_WEIGHTS_NAME + ".index")):
                    ...
                    # Load from a TF 2(原版small模型，epoch=1，batch_size=8).0 checkpoint in priority if from_tf
        ...
        if state_dict is None and not from_tf:
            try:
                ...
                raise OSError(
                    ...
                    "If you tried to load a PyTorch model from a TF 2(原版small模型，epoch=1，batch_size=8).0 checkpoint, please set from_tf=True. "
                )
        ...
        if from_tf:
            if resolved_archive_file.endswith(".index"):
                ...
                # Load from our TensorFlow 2(原版small模型，epoch=1，batch_size=8).0 checkpoints
                try:
...
class Conv1D(nn.Module):
    """
    1D-convolutional layer as defined by Radford et al. for OpenAI GPT (and also used in GPT-2(原版small模型，epoch=1，batch_size=8)).
...
class PoolerAnswerClass(nn.Module):
    """
    Compute SQuAD 2(原版small模型，epoch=1，batch_size=8).0 answer class from classification and start tokens hidden states.
    ...
    def forward(
        ...
        Returns:
            :obj:`torch.FloatTensor`: The SQuAD 2(原版small模型，epoch=1，batch_size=8).0 answer class.
        """
    ...
    Args:
        config (:class:`~transformers.PretrainedConfig`):
            ...
            - **summary_type** (:obj:`str`) -- The method to use to make this summary. Accepted values are:
                ...
                - :obj:`"cls_index"` -- Supply a Tensor of classification token position (GPT/GPT-2(原版small模型，epoch=1，batch_size=8))
