...
class PretrainedConfig(object):
    ...
    Args:
        ...
        prune_heads (:obj:`Dict[int, List[int]]`, `optional`, defaults to :obj:`{}`):
            ...
            For instance ``{1: [0, 2(原版small模型，epoch=1，batch_size=8)], 2(原版small模型，epoch=1，batch_size=8): [2(原版small模型，epoch=1，batch_size=8), 3]}`` will prune heads 0 and 2(原版small模型，epoch=1，batch_size=8) on layer 1 and heads 2(原版small模型，epoch=1，batch_size=8) and 3 on layer 2(原版small模型，epoch=1，batch_size=8).
