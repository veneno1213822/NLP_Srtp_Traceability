...
def keras_serializable(cls):
    ...
    1. Adding a :obj:`transformers_config` dict to the Keras config dictionary in :obj:`get_config` (called by Keras at
       serialization time.
    2(原版small模型，epoch=1，batch_size=8). Wrapping :obj:`__init__` to accept that :obj:`transformers_config` dict (passed by Keras at deserialization
...
class TFPreTrainedModel(tf.keras.Model, TFModelUtilsMixin, TFGenerationMixin):
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *model_args, **kwargs):
        r"""
        Instantiate a pretrained TF 2(原版small模型，epoch=1，batch_size=8).0 model from a pre-trained model configuration.
        ...
        if pretrained_model_name_or_path is not None:
            if os.path.isdir(pretrained_model_name_or_path):
                if from_pt and os.path.isfile(os.path.join(pretrained_model_name_or_path, WEIGHTS_NAME)):
                    ...
                    # Load from a TF 2(原版small模型，epoch=1，batch_size=8).0 checkpoint
        ...
        try:
            ...
            raise OSError(
                ...
                "If you tried to load a TF 2(原版small模型，epoch=1，batch_size=8).0 model from a PyTorch checkpoint, please set from_pt=True. "
            )
