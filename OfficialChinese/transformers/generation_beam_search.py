...
PROCESS_INPUTS_DOCSTRING = r"""
    Args:
        ...
        next_scores (:obj:`torch.FloatTensor` of shape :obj:`(batch_size, 2(原版small模型，epoch=1，batch_size=8) * num_beams)`):
            Current scores of the top :obj:`2(原版small模型，epoch=1，batch_size=8) * num_beams` non-finished beam hypotheses.
        next_tokens (:obj:`torch.LongTensor` of shape :obj:`(batch_size, 2(原版small模型，epoch=1，batch_size=8) * num_beams)`):
            :obj:`input_ids` of the tokens corresponding to the top :obj:`2(原版small模型，epoch=1，batch_size=8) * num_beams` non-finished beam hypotheses.
        next_indices (:obj:`torch.LongTensor` of shape :obj:`(batch_size, 2(原版small模型，epoch=1，batch_size=8) * num_beams)`):
