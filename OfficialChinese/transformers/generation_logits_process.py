...
class NoBadWordsLogitsProcessor(LogitsProcessor):
    ...
    def _set_scores_to_inf_for_banned_tokens(self, scores: torch.Tensor, banned_tokens: List[List[int]]) -> None:
        ...
        # A sparse tensor is generated from a list of coordinates: [[0, 1], [0, 2(原版small模型，epoch=1，batch_size=8)], [2(原版small模型，epoch=1，batch_size=8), 0]]. A conversion to dense tensor generates:
        # [ 0  1  1 ]
        # [ 0  0  0 ]
        # [ 1  0  0 ]
...
class PrefixConstrainedLogitsProcessor(LogitsProcessor):
    ...
    Args:
        prefix_allowed_tokens_fn: (:obj:`Callable[[int, torch.Tensor], List[int]]`):
            This function constraints the beam search to allowed tokens only at each step. This function takes 2(原版small模型，epoch=1，batch_size=8)
