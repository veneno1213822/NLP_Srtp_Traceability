...
class TrainingArguments:
    ...
    Parameters:
        ...
        past_index (:obj:`int`, `optional`, defaults to -1):
            ...
            ``Trainer`` will use the corresponding output (usually index 2(原版small模型，epoch=1，batch_size=8)) as the past state and feed it to the model
    ...
    def _setup_devices(self) -> Tuple["torch.device", int]:
        ...
        if self.no_cuda:
            ...
            # GPUs available in the environment, so `CUDA_VISIBLE_DEVICES=1,2(原版small模型，epoch=1，batch_size=8)` with `cuda:0`
