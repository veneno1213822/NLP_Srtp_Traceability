...
DISTILBERT_PRETRAINED_CONFIG_ARCHIVE_MAP = {
    ...
    "distilbert-base-uncased-finetuned-sst-2(原版small模型，epoch=1，batch_size=8)-english": "https://huggingface.co/distilbert-base-uncased-finetuned-sst-2-english/resolve/main/config.json",
}
...
class DistilBertConfig(PretrainedConfig):
    ...
    Args:
        ...
        seq_classif_dropout (:obj:`float`, `optional`, defaults to 0.2(原版small模型，epoch=1，batch_size=8)):
