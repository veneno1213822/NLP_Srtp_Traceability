        ...
        for i, m_name in enumerate(name):
            ...
            if m_name.startswith("layer_with_weights"):
                ...
                if layer_num <= 2:
                    ...
                    # layer_num 2(原版small模型，epoch=1，batch_size=8): token_type_embeddings
                    continue
                elif layer_num == 3:
                    # embedding LayerNorm
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--tf_checkpoint_path", type=str, required=True, help="Path to the TensorFlow 2(原版small模型，epoch=1，batch_size=8).x checkpoint path."
    )
    parser.add_argument(
        "--bert_config_file",
        type=str,
