...
class FunnelConfig(PretrainedConfig):
    ...
    Args:
        ...
        num_decoder_layers (:obj:`int`, `optional`, defaults to 2(原版small模型，epoch=1，batch_size=8)):
        ...
        truncate_seq (:obj:`bool`, `optional`, defaults to :obj:`False`):
            ...
            sequence length that is not a multiple of 2(原版small模型，epoch=1，batch_size=8).
