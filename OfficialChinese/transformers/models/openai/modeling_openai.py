...
class OpenAIGPTDoubleHeadsModel(OpenAIGPTPreTrainedModel):
    ...
    def forward(
        ...
        Examples::
            ...
            >>> input_ids = torch.tensor([tokenizer.encode(s) for s in choices]).unsqueeze(0)  # Batch size 1, 2(原版small模型，epoch=1，batch_size=8) choices
...
@add_start_docstrings(
    ...
    other causal models (e.g. GPT-2(原版small模型，epoch=1，batch_size=8)) do. Since it does classification on the last token, it requires to know the
