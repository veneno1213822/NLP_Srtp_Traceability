...
class BartConfig(PretrainedConfig):
    ...
    Args:
        ...
        eos_token_id (:obj:`int`, `optional`, defaults to 2(原版small模型，epoch=1，batch_size=8))
        ...
        decoder_layerdrop: (:obj:`float`, `optional`, defaults to 0.0):
            ...
            https://arxiv.org/abs/1909.11556>`__ for more details.
        extra_pos_embeddings: (:obj:`int`, `optional`, defaults to 2(原版small模型，epoch=1，batch_size=8)):
    ...
    def __init__(
        ...
        **common_kwargs
        ...
        # bart has a hack that offsets positional embeddings by 2(原版small模型，epoch=1，batch_size=8), other models don't do this
