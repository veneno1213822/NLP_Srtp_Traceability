...
""" TF 2(原版small模型，epoch=1，batch_size=8).0 MobileBERT model. """
...
class TFMobileBertForPreTrainingOutput(ModelOutput):
    ...
    Args:
        ...
        seq_relationship_logits (:obj:`tf.Tensor` of shape :obj:`(batch_size, 2(原版small模型，epoch=1，batch_size=8))`):
...
class TFMobileBertForPreTraining(TFMobileBertPreTrainedModel):
    ...
    def call(self, inputs, **kwargs):
        ...
        Examples::
            ...
            >>> prediction_scores, seq_relationship_scores = outputs[:2(原版small模型，epoch=1，batch_size=8)]
