...
TF_DPR_START_DOCSTRING = r"""
    ...
    subclass. Use it as a regular TF 2(原版small模型，epoch=1，batch_size=8).0 Keras Model and refer to the TF 2(原版small模型，epoch=1，batch_size=8).0 documentation for all matter related to
    general usage and behavior.

    .. note::

        TF 2(原版small模型，epoch=1，batch_size=8).0 models accepts two formats as inputs: - having all inputs as keyword arguments (like PyTorch models), or
...
TF_DPR_READER_INPUTS_DOCSTRING = r"""
    Args:
        input_ids: (:obj:`Numpy array` or :obj:`tf.Tensor` of shapes :obj:`(n_passages, sequence_length)`):
            ...
            and 2(原版small模型，epoch=1，batch_size=8)) the passages titles and 3) the passages texts To match pretraining, DPR :obj:`input_ids` sequence
