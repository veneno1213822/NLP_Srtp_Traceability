    ...
    def forward(
        ...
        **kwargs  # needs kwargs for generation
        ...
        Example::
            ...
            >>> # 2(原版small模型，epoch=1，batch_size=8). Retrieve
            >>> docs_dict = retriever(input_ids.numpy(), question_hidden_states.detach().numpy(), return_tensors="pt")
            >>> doc_scores = torch.bmm(question_hidden_states.unsqueeze(1), docs_dict["retrieved_doc_embeds"].float().transpose(1, 2(原版small模型，epoch=1，batch_size=8))).squeeze(1)
        ...
        **model_kwargs
        ...
        Args:
            ...
            prefix_allowed_tokens_fn: (:obj:`Callable[[int, torch.Tensor], List[int]]`, `optional`):
                ...
                provided no constraint is applied. This function takes 2(原版small模型，epoch=1，batch_size=8) arguments :obj:`inputs_ids` and the batch ID
