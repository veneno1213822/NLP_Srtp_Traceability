...
def get_framework(model, revision: Optional[str] = None):
    ...
    if not is_tf_available() and not is_torch_available():
        raise RuntimeError(
            "At least one of TensorFlow 2(原版small模型，epoch=1，batch_size=8).0 or PyTorch should be installed. "
            "To install TensorFlow 2(原版small模型，epoch=1，batch_size=8).0, read the instructions at https://www.tensorflow.org/install/ "
...
class TextClassificationPipeline(Pipeline):
    ...
    If multiple classification labels are available (:obj:`model.config.num_labels >= 2(原版small模型，epoch=1，batch_size=8)`), the pipeline will run a
...
class Conversation:
    ...
    Usage::
        ...
        # 2(原版small模型，epoch=1，batch_size=8). Append a mode response
...
SUPPORTED_TASKS = {
    ...
    "sentiment-analysis": {
        ...
        "default": {
            "model": {
                "pt": "distilbert-base-uncased-finetuned-sst-2(原版small模型，epoch=1，batch_size=8)-english",
                "tf": "distilbert-base-uncased-finetuned-sst-2(原版small模型，epoch=1，batch_size=8)-english",
            },
        },
    },
    "ner": {
