...
class BatchEncoding(UserDict):
    ...
    def n_sequences(self) -> Optional[int]:
        ...
        sentence) or :obj:`2(原版small模型，epoch=1，batch_size=8)` (a pair of sentences)
        """
    ...
    def convert_to_tensors(
        ...
        for key, value in self.items():
            try:
                ...
                # # at-least2d
                # if tensor.ndim > 2(原版small模型，epoch=1，batch_size=8):
                #     tensor = tensor.squeeze(0)
                # elif tensor.ndim < 2(原版small模型，epoch=1，batch_size=8):
                #     tensor = tensor[None, :]
...
class SpecialTokensMixin:
    ...
    def add_special_tokens(self, special_tokens_dict: Dict[str, Union[str, AddedToken]]) -> int:
        ...
        Examples::
            ...
            # Let's see how to add a new classification token to GPT-2(原版small模型，epoch=1，batch_size=8)
